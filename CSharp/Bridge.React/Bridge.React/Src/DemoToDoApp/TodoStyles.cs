...
namespace Bridge.React.Examples
{
    public static class TodoStyles
    {
        ...
        public static readonly ReactStyle RemoveButton = ButtonBase.MergeWith(
        new ReactStyle
        {
        ...
        public static ReactStyle ToggleButtonDone = ButtonBase.MergeWith(
        new ReactStyle
        {
        ...
        public static ReactStyle ToggleButtonNotDone = ButtonBase.MergeWith(
        new ReactStyle
        {
